...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="_lstvwTypeCRUD" runat="server" DataSourceID="_dtsrcTypeCRUD" DataKeyNames="USERTYPEID" InsertItemPosition="LastItem" OnDataBound="_lstvwTypeCRUD_DataBound" OnItemInserting="_lstvwTypeCRUD_ItemInserting" OnItemUpdating="_lstvwTypeCRUD_ItemUpdating" OnItemInserted="_lstvwTypeCRUD_ItemInserted" OnItemUpdated="_lstvwTypeCRUD_ItemUpdated">
        ...
        <ItemTemplate>
            ...
            <div style="" class="col-sm-4 well">
                ...
                <asp:SqlDataSource runat="server" ID="_dtsrcUserPermit" ConnectionString='<%$ ConnectionStrings:_cnnstrngUserDBOne %>' SelectCommand="SELECT PERMIT.PERMITNAME, USERPERMIT.USERTYPEID, USERPERMIT.PERMITID FROM PERMIT INNER JOIN USERPERMIT ON PERMIT.PERMITID = USERPERMIT.PERMITID WHERE (USERPERMIT.USERTYPEID = @UserTypeID)">
                    <SelectParameters>
    ...
    <asp:SqlDataSource runat="server" ID="_dtsrcTypeCRUD" ConnectionString='<%$ ConnectionStrings:_cnnstrngUserDBOne %>' SelectCommand="SELECT [USERTYPEID], [USERTYPENAME] FROM [USERTYPE] WHERE ([USERTYPEID] = @USERTYPEID)" DeleteCommand="DELETE FROM [USERTYPE] WHERE [USERTYPEID] = @USERTYPEID" InsertCommand="INSERT INTO [USERTYPE] ([USERTYPENAME]) VALUES (@USERTYPENAME)" UpdateCommand="UPDATE [USERTYPE] SET [USERTYPENAME] = @USERTYPENAME WHERE [USERTYPEID] = @USERTYPEID">
        <DeleteParameters>
